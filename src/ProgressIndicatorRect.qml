...
Item {
    ...
    onWidthChanged: {
        lower.itemlen = typeof root.sections !== "undefined" ? root.width/(root.sections.length) : 0;
        upper.itemlen = typeof root.sections !== "undefined" ? root.width/(root.sections[currentSection].length) : 0;
    ...
    onCurrentSectionChanged: {
        upper.itemlen = root.sections !== "undefined" ? root.width/(root.sections[currentSection].length) : 0;
        ...
        Repeater {
            ...
            delegate: Rectangle {
                ...
                Text {
                    ...
                    text: index == root.currentSection ? root.sectionHeaders[index] : ""
